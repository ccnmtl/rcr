...
winprops = 'height='+400+',width='+540+',top='+wint+',left='+winl+',resizable=no,scrollbars=yes,status=no,menubar=no,directories=no,toolbar=no'
...
var winl = (screen.width - 600) / 2;
var wint = (screen.height - 500) / 2;
winprops = 'height='+500+',width='+540+',top='+wint+',left='+winl+',resizable=no,scrollbars=yes,status=no,menubar=no,directories=no,toolbar=no'
